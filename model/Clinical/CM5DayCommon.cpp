...
mon::Measure CM5DayCommon::measures[NumCaseTypes] = {
    mon::nTreatments1,  // first line official
    mon::nTreatments2   // second line official
};
...
void CM5DayCommon::severeMalaria (
    ...
    mon::recordStat(mon::expectedHospitalDeaths, human, exHospitalDeath);
    mon::recordStat(mon::expectedDirectDeaths, human, exDeath);
    ...
    mon::recordStat(mon::expectedSequelae, human, exSeq);
